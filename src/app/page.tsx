      ...
      <main className="container mx-auto px-6 py-8 max-w-[1024px]">
        <section className="text-center mb-16  ">
          ...
          <p className="text-xl text-gray-600  dark:text-gray-300 mb-8">
            ...
            abaixo"repositório", valido lembrar que neste portfólio estou colocando 
            outros projetos além dos presentes no repositório citado anteriormente.
          </p>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
          ...
          >
            <Button className="text-lg mr-4">Repositório</Button>
          </a>
            ...
            <Card className="col-span-1 md:col-span-2">
              <CardContent className="pt-6">
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  ...
                  finalizado em 2024, estou sempre em busca de novos desafios e
                  aprendizado. Tenho experiência em desenvolvimento de mais de 2
                  anos, porém profissionalmente eu possuo somente um ano de
                  experiencia
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Eu me especializei em desenvolvimento web e mobile usando
                  tecnologias como React, React Native, Node.js. Utilizo também
                  os frameworks Next.js e Vue.js para criar aplicativos web
                  modernos e responsivos.
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  Para o desenvolvimento back-end tenho experiencia em Java e
                  estou estudando c# para que possa engrandecer ainda mais meus
                  projetos.
                </p>
              </CardContent>
            </Card>
